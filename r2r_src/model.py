...
class EncoderLSTM(nn.Module):
    ...
    def __init__(self, vocab_size, embedding_size, hidden_size, padding_idx, 
        ...
        embed = nn.Embedding(vocab_size, embedding_size, padding_idx)
...
class SpeakerDecoder(nn.Module):
    def __init__(self, vocab_size, embedding_size, padding_idx, hidden_size, dropout_ratio):
        ...
        # print(torch.FloatTensor([list(map(float, g)) for g in glove_vec.values()]).size())
        self.embedding = embed.from_pretrained(torch.FloatTensor([list(map(float, g)) for g in glove_vec.values()]), padding_idx)
        self.embedding.weight.requires_grad = False
